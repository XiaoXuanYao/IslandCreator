...
public class Creator {
    ...
    public static void genIsland(PlayerEntity player, World world) {
        ...
        for (int x = -Radius; x < Radius; x++) {
            calcIsland(x, NoiseMap, NoiseMap2, A, h, StdPos, world);
        }
    }

    private static void calcIsland(int x, float[][] noiseMap, float[][] noiseMap2, float A, int h, Vec3i stdPos, World world) {
